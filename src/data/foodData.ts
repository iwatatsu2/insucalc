...
export const foodData: Record<string, FoodItem[]> = {
  "主食": [
    ...
    { name: "白米 小（100g）", carbs: 36, category: "主食", tags: ["和食", "主食"], source: "官公庁DB" },
    { name: "白米 中（150g）", carbs: 53, category: "主食", tags: ["和食", "主食"], source: "官公庁DB" },
    { name: "白米 大（200g）", carbs: 71, category: "主食", tags: ["和食", "主食", "高糖質"], source: "官公庁DB" },
    { name: "白米 特盛（250g）", carbs: 89, category: "主食", tags: ["和食", "主食", "高糖質"], source: "官公庁DB" },
    // 玄米 水稲めし: 34.2g/100g（八訂）
    { name: "玄米 150g", carbs: 51, category: "主食", tags: ["和食", "主食"], source: "官公庁DB" },
    // もち米: 35.1g/100g（おこわ）
    { name: "もち米おこわ 150g", carbs: 53, category: "主食", tags: ["和食", "主食"], source: "官公庁DB" },
    ...
    // 赤飯: 39.7g/100g（八訂）
    { name: "赤飯 150g", carbs: 60, category: "主食", tags: ["和食", "主食"], source: "官公庁DB" },
  ...
  "おにぎり・パン": [
    ...
    { name: "おにぎり 梅（コンビニ）", carbs: 37, category: "おにぎり・パン", tags: ["和食", "コンビニ"], source: "官公庁DB" },
    { name: "おにぎり ツナマヨ（コンビニ）", carbs: 37, category: "おにぎり・パン", tags: ["和食", "コンビニ"], source: "官公庁DB" },
    { name: "おにぎり 鮭（コンビニ）", carbs: 37, category: "おにぎり・パン", tags: ["和食", "コンビニ"], source: "官公庁DB" },
    { name: "おにぎり 昆布（コンビニ）", carbs: 37, category: "おにぎり・パン", tags: ["和食", "コンビニ"], source: "官公庁DB" },
    { name: "大きめおにぎり 1個（140g）", carbs: 50, category: "おにぎり・パン", tags: ["和食"], source: "官公庁DB" },
    // 食パン: 44.4g/100g（八訂）。6枚切り1枚=60g, 8枚切り=45g, 4枚切り=90g
    { name: "食パン 6枚切り1枚（60g）", carbs: 27, category: "おにぎり・パン", tags: ["パン"], source: "官公庁DB" },
    { name: "食パン 8枚切り1枚（45g）", carbs: 20, category: "おにぎり・パン", tags: ["パン"], source: "官公庁DB" },
    { name: "食パン 4枚切り1枚（90g）", carbs: 40, category: "おにぎり・パン", tags: ["パン", "高糖質"], source: "官公庁DB" },
    { name: "トースト 6枚切り1枚（バター）", carbs: 27, category: "おにぎり・パン", tags: ["パン"], source: "官公庁DB" },
    // クロワッサン: 42.0g/100g（八訂）。1個=45g
    { name: "クロワッサン 1個（45g）", carbs: 19, category: "おにぎり・パン", tags: ["パン"], source: "官公庁DB" },
    // フランスパン: 57.5g/100g（八訂）。3切れ=60g
    { name: "バゲット 3切れ（60g）", carbs: 35, category: "おにぎり・パン", tags: ["パン"], source: "官公庁DB" },
    // ロールパン: 48.6g/100g（八訂）。1個=30g×2
    { name: "ロールパン 2個（60g）", carbs: 29, category: "おにぎり・パン", tags: ["パン"], source: "官公庁DB" },
    { name: "イングリッシュマフィン 1個（60g）", carbs: 26, category: "おにぎり・パン", tags: ["パン"], source: "官公庁DB" },
    { name: "ベーグル 1個（90g）", carbs: 48, category: "おにぎり・パン", tags: ["パン", "高糖質"], source: "推計" },
  ],
  "菓子パン・軽食": [
    // あんぱん: 51.7g/100g（八訂）。1個=90g
    { name: "あんぱん 1個（90g）", carbs: 47, category: "菓子パン・軽食", tags: ["パン", "高糖質"], source: "官公庁DB" },
    // クリームパン: 45.5g/100g（八訂）。1個=80g
    { name: "クリームパン 1個（80g）", carbs: 36, category: "菓子パン・軽食", tags: ["パン"], source: "官公庁DB" },
    // メロンパン: 58.2g/100g（八訂）。1個=100g
    { name: "メロンパン 1個（100g）", carbs: 58, category: "菓子パン・軽食", tags: ["パン", "高糖質"], source: "官公庁DB" },
    ...
    { name: "肉まん 1個（90g）", carbs: 32, category: "菓子パン・軽食", tags: ["中華", "コンビニ"], source: "官公庁DB" },
    // あんまん: 44.3g/100g（八訂）。1個=90g
    { name: "あんまん 1個（90g）", carbs: 40, category: "菓子パン・軽食", tags: ["中華", "コンビニ", "高糖質"], source: "官公庁DB" },
    { name: "ピザまん 1個（90g）", carbs: 30, category: "菓子パン・軽食", tags: ["中華", "コンビニ"], source: "推計" },
    // ホットケーキ: 44.7g/100g（八訂）。2枚=150g
    { name: "ホットケーキ 2枚（150g）", carbs: 67, category: "菓子パン・軽食", tags: ["洋食", "高糖質"], source: "官公庁DB" },
    { name: "ワッフル 2個（100g）", carbs: 43, category: "菓子パン・軽食", tags: ["洋食", "高糖質"], source: "推計" },
  ],
  "麺類": [
    // 中華めん（ゆで）: 27.9g/100g（八訂）。ラーメン1杯=麺200g+スープ
    { name: "ラーメン（醤油）", carbs: 58, category: "麺類", tags: ["外食", "高糖質"], source: "官公庁DB" },
    { name: "ラーメン（豚骨）", carbs: 59, category: "麺類", tags: ["外食", "高糖質"], source: "官公庁DB" },
    { name: "ラーメン（味噌）", carbs: 60, category: "麺類", tags: ["外食", "高糖質"], source: "官公庁DB" },
    { name: "つけ麺 1人前", carbs: 68, category: "麺類", tags: ["外食", "高糖質"], source: "推計" },
    // うどん（ゆで）: 20.8g/100g（八訂）。1人前=250g
    { name: "うどん（かけ）", carbs: 52, category: "麺類", tags: ["和食", "高糖質"], source: "官公庁DB" },
    { name: "うどん（ざる）", carbs: 52, category: "麺類", tags: ["和食", "高糖質"], source: "官公庁DB" },
    { name: "うどん（肉）", carbs: 54, category: "麺類", tags: ["和食", "高糖質"], source: "官公庁DB" },
    { name: "天ぷらうどん", carbs: 62, category: "麺類", tags: ["和食", "高糖質"], source: "官公庁DB" },
    // そば（ゆで）: 23.1g/100g（八訂）。1人前=200g
    { name: "そば（もり）", carbs: 46, category: "麺類", tags: ["和食"], source: "官公庁DB" },
    { name: "そば（かけ）", carbs: 46, category: "麺類", tags: ["和食"], source: "官公庁DB" },
    { name: "そば（天ぷら）", carbs: 56, category: "麺類", tags: ["和食", "高糖質"], source: "官公庁DB" },
    // 中華めん（ゆで）焼きそば: 27.9g/100g×200g
    { name: "焼きそば 1人前", carbs: 56, category: "麺類", tags: ["外食", "高糖質"], source: "官公庁DB" },
    // スパゲッティ（ゆで）: 30.3g/100g（八訂）。1人前=200g
    { name: "パスタ（ナポリタン）", carbs: 65, category: "麺類", tags: ["洋食", "高糖質"], source: "官公庁DB" },
    { name: "パスタ（カルボナーラ）", carbs: 61, category: "麺類", tags: ["洋食", "高糖質"], source: "官公庁DB" },
    { name: "パスタ（ペペロンチーノ）", carbs: 61, category: "麺類", tags: ["洋食", "高糖質"], source: "官公庁DB" },
    { name: "パスタ（ミートソース）", carbs: 63, category: "麺類", tags: ["洋食", "高糖質"], source: "官公庁DB" },
    { name: "パスタ（ボンゴレ）", carbs: 61, category: "麺類", tags: ["洋食", "高糖質"], source: "官公庁DB" },
    ...
    { name: "インスタントラーメン（袋）", carbs: 52, category: "麺類", tags: ["高糖質"], source: "官公庁DB" },
  ...
  "ファストフード": [
    ...
    { name: "フライドポテト M（135g）", carbs: 52, category: "ファストフード", tags: ["外食", "高糖質"], source: "官公庁DB" },
    { name: "フライドポテト L（170g）", carbs: 65, category: "ファストフード", tags: ["外食", "高糖質"], source: "官公庁DB" },
    ...
    { name: "たこ焼き 8個（160g）", carbs: 37, category: "ファストフード", tags: ["外食"], source: "官公庁DB" },
    // お好み焼き: 21.3g/100g（八訂）。1枚=200g
    { name: "お好み焼き 1枚（200g）", carbs: 43, category: "ファストフード", tags: ["外食", "高糖質"], source: "官公庁DB" },
  ],
  "コンビニ食品": [
    ...
    { name: "冷凍うどん（1袋・250g）", carbs: 52, category: "コンビニ食品", tags: ["コンビニ", "高糖質"], source: "官公庁DB" },
    { name: "サラダチキン 1個", carbs: 1, category: "コンビニ食品", tags: ["コンビニ", "低糖質"], source: "推計" },
    { name: "ゆで卵 2個", carbs: 1, category: "コンビニ食品", tags: ["コンビニ", "低糖質"], source: "官公庁DB" },
    ...
    { name: "コンビニプリン 1個（100g）", carbs: 15, category: "コンビニ食品", tags: ["コンビニ", "スイーツ"], source: "官公庁DB" },
    { name: "フルーツゼリー", carbs: 20, category: "コンビニ食品", tags: ["コンビニ", "スイーツ"], source: "推計" },
    // ヨーグルト（全脂・加糖）: 11.9g/100g（八訂）。1個=100g
    { name: "ヨーグルト（加糖）1個（100g）", carbs: 12, category: "コンビニ食品", tags: ["コンビニ"], source: "官公庁DB" },
    // ヨーグルト（全脂・無糖）: 4.9g/100g（八訂）
    { name: "ヨーグルト（無糖）1個（100g）", carbs: 5, category: "コンビニ食品", tags: ["コンビニ", "低糖質"], source: "官公庁DB" },
  ],
  "スイーツ": [
    // ショートケーキ: 44.4g/100g（八訂）。1個=100g
    { name: "ショートケーキ 1個（100g）", carbs: 44, category: "スイーツ", tags: ["スイーツ", "高糖質"], source: "官公庁DB" },
    ...
    { name: "チーズケーキ 1個（100g）", carbs: 24, category: "スイーツ", tags: ["スイーツ"], source: "官公庁DB" },
    // シュークリーム: 25.9g/100g（八訂）。1個=80g
    { name: "シュークリーム 1個（80g）", carbs: 21, category: "スイーツ", tags: ["スイーツ"], source: "官公庁DB" },
    { name: "エクレア 1個（80g）", carbs: 26, category: "スイーツ", tags: ["スイーツ"], source: "推計" },
    // どら焼き: 55.5g/100g（八訂）。1個=90g
    { name: "どら焼き 1個（90g）", carbs: 50, category: "スイーツ", tags: ["和菓子", "高糖質"], source: "官公庁DB" },
    // 大福もち: 50.2g/100g（八訂）。1個=60g
    { name: "大福 1個（60g）", carbs: 30, category: "スイーツ", tags: ["和菓子", "高糖質"], source: "官公庁DB" },
    // おはぎ: 42.7g/100g（八訂）。1個=80g
    { name: "おはぎ 1個（80g）", carbs: 34, category: "スイーツ", tags: ["和菓子", "高糖質"], source: "官公庁DB" },
    // みたらし団子: 42.6g/100g（八訂）。3本=90g
    { name: "みたらし団子 3本（90g）", carbs: 38, category: "スイーツ", tags: ["和菓子", "高糖質"], source: "官公庁DB" },
    // 練り羊羹: 66.7g/100g（八訂）。小棹1本=60g
    { name: "羊羹（小棹）1本（60g）", carbs: 40, category: "スイーツ", tags: ["和菓子", "高糖質"], source: "官公庁DB" },
    // アイスクリーム（高脂肪）: 22.2g/100g（八訂）。1個=90g
    { name: "アイスクリーム（カップ）1個（90g）", carbs: 20, category: "スイーツ", tags: ["スイーツ"], source: "官公庁DB" },
    ...
    // プリン: 14.9g/100g（八訂）。1個=100g
    { name: "プリン 1個（100g）", carbs: 15, category: "スイーツ", tags: ["スイーツ"], source: "官公庁DB" },
    // ドーナツ（イースト）: 42.5g/100g（八訂）。1個=70g
    { name: "ドーナツ（プレーン）1個（70g）", carbs: 30, category: "スイーツ", tags: ["スイーツ"], source: "官公庁DB" },
    // チョコレート: 51.9g/100g（八訂）。1/3板=20g
    { name: "チョコレート板（1/3・20g）", carbs: 10, category: "スイーツ", tags: ["スイーツ"], source: "官公庁DB" },
    // せんべい（しょうゆ）: 84.4g/100g（八訂）。5枚=30g
    { name: "せんべい 5枚（30g）", carbs: 25, category: "スイーツ", tags: ["和菓子"], source: "官公庁DB" },
    // ポテトチップス: 50.5g/100g（八訂）。1袋60g
    { name: "ポテトチップス 1袋（60g）", carbs: 30, category: "スイーツ", tags: ["スナック"], source: "官公庁DB" },
  ...
  "飲料": [
    ...
    { name: "スポーツドリンク 500ml", carbs: 31, category: "飲料", tags: ["飲料"], source: "官公庁DB" },
    // オレンジジュース: 11.0g/100ml（八訂・果実飲料・濃縮還元）
    { name: "オレンジジュース 200ml", carbs: 22, category: "飲料", tags: ["飲料"], source: "官公庁DB" },
    // りんごジュース: 11.3g/100ml（八訂・果実飲料・濃縮還元）
    { name: "りんごジュース 200ml", carbs: 23, category: "飲料", tags: ["飲料"], source: "官公庁DB" },
    // 野菜ジュース: 3.7g/100ml（八訂）
    { name: "野菜ジュース 200ml", carbs: 7, category: "飲料", tags: ["飲料"], source: "官公庁DB" },
    // 牛乳: 4.8g/100ml（八訂）
    { name: "牛乳 200ml", carbs: 10, category: "飲料", tags: ["飲料"], source: "官公庁DB" },
    // 豆乳（無調整）: 2.9g/100ml（八訂）
    { name: "豆乳（無調整）200ml", carbs: 6, category: "飲料", tags: ["飲料", "低糖質"], source: "官公庁DB" },
    // 豆乳（調製）: 4.5g/100ml（八訂）
    { name: "豆乳（調製）200ml", carbs: 9, category: "飲料", tags: ["飲料"], source: "官公庁DB" },
    ...
    { name: "緑茶・麦茶 500ml", carbs: 0, category: "飲料", tags: ["飲料", "低糖質"], source: "官公庁DB" },
    ...
    { name: "甘酒 200ml", carbs: 37, category: "飲料", tags: ["飲料", "和食", "高糖質"], source: "官公庁DB" },
    { name: "ポカリスエット 500ml", carbs: 31, category: "飲料", tags: ["飲料"], source: "推計" },
  ],
  "果物": [
    // バナナ: 21.4g/100g（八訂）。中1本=100g
    { name: "バナナ 1本（中・100g）", carbs: 21, category: "果物", tags: ["果物", "高糖質"], source: "官公庁DB" },
    { name: "バナナ 2本（200g）", carbs: 43, category: "果物", tags: ["果物", "高糖質"], source: "官公庁DB" },
    // りんご（皮なし）: 14.3g/100g（八訂）。1/2個=125g
    { name: "りんご 1/2個（125g）", carbs: 18, category: "果物", tags: ["果物"], source: "官公庁DB" },
    { name: "りんご 1個（250g）", carbs: 36, category: "果物", tags: ["果物", "高糖質"], source: "官公庁DB" },
    // みかん: 11.0g/100g（八訂）。1個=80g
    { name: "みかん 2個（160g）", carbs: 18, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // ぶどう（皮なし）: 15.2g/100g（八訂）。1房=150g
    { name: "ぶどう 1房（150g）", carbs: 23, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // 桃（皮なし）: 8.9g/100g（八訂）。1個=200g
    { name: "桃 1個（200g）", carbs: 18, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // いちご: 7.1g/100g（八訂）。10粒=200g
    { name: "いちご 10粒（200g）", carbs: 14, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // スイカ（皮なし）: 9.2g/100g（八訂）。1切れ=200g
    { name: "スイカ 1切れ（200g）", carbs: 18, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // メロン（温室・果肉）: 9.8g/100g（八訂）。1/6個=170g
    { name: "メロン 1/6個（170g）", carbs: 17, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // キウイフルーツ（黄）: 14.0g/100g（八訂）。1個=100g
    { name: "キウイ 2個（200g）", carbs: 28, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // 日本なし（皮なし）: 10.4g/100g（八訂）。1/2個=150g
    { name: "梨 1/2個（150g）", carbs: 16, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // マンゴー（果肉）: 15.6g/100g（八訂）。1/2個=150g
    { name: "マンゴー 1/2個（150g）", carbs: 23, category: "果物", tags: ["果物"], source: "官公庁DB" },
    // パインアップル: 11.9g/100g（八訂）。2切れ=100g
    { name: "パイナップル 2切れ（100g）", carbs: 12, category: "果物", tags: ["果物"], source: "官公庁DB" },
