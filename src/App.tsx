...
export default function App() {
  ...
  const handleSave = () => {
    ...
    addEntry({
      ...
      foods: selectedFoods.map(f => f.name),
      totalCarbs,
      currentBg: bg,
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{
            ...
            <span style={{ color: '#fff', fontSize: 10, fontWeight: 900, letterSpacing: '-0.5px', lineHeight: 1 }}>💉</span>
          </div>
          <div>
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          ...
          <button onClick={() => setShowGuide(true)} style={{
            ...
            color: '#64748B', borderRadius: 20, padding: '5px 10px',
      ...
      <div style={{ padding: '16px 16px 100px' }}>
        ...
        <section style={{ marginBottom: 20 }}>
          ...
          <FoodSelector
            ...
            onAdd={f => setSelectedFoods(prev => [...prev, f])}
            onRemove={i => setSelectedFoods(prev => prev.filter((_, idx) => idx !== i))}
          />
        </section>
